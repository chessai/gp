  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "uri-encode".revision = (((hackage."uri-encode")."1.5.0.5").revisions).default;
        ...
        "cborg-json".revision = (((hackage."cborg-json")."0.2.1.0").revisions).default;
        ...
        "aeson-pretty".revision = (((hackage."aeson-pretty")."0.8.0").revisions).default;
        ...
        "dhall".revision = (((hackage."dhall")."1.26.1").revisions).default;
        "dhall".flags.with-http = true;
        "dhall".flags.cross = false;
        "terminfo".revision = (((hackage."terminfo")."0.4.1.2").revisions).default;
        "prettyprinter".revision = (((hackage."prettyprinter")."1.3.0").revisions).default;
        ...
        "dotgen".revision = (((hackage."dotgen")."0.4.2").revisions).default;
